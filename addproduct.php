...
<html lang="en">
  ...
  <body class="violetgradient">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <input type="text" class="forminput" id="prodname" required><br><br>
                        <label type="text" class="formlabel"> Product Description </label>
                        <input type="text" class="forminput" id="prodDescription" required><br><br>
                        <label type="text" class="formlabel"> Product Expiry Date [YYYY-MM-DD]</label>
                        <input type="text" class="forminput" id="expiryDate" required><br>
                        <input type="hidden" class="forminput" id="user" value=<?php echo $_SESSION['username']; ?> required>
                    </div>
                    <button class="formbtn" id="mansub" type="submit" onclick="upload()">Register Item</button>
                </form>
            </div>
        </div>
    ...
    $('#form1').on('submit', function(event) {
        ...
        username = $('#user').val(); 
        prodDescription=prodDescription+"<br>Expiry Date: "+expiryDate+"<br>Registered By: "+username;
        ...
        web3.eth.getAccounts().then(async function(accounts) {
          var receipt = await contract.methods.newItem(prodname,prodDescription, thisdate).send({ from: accounts[0], gas: 1000000 })
          .then(receipt => {
