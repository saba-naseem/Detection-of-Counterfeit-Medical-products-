  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1">
            <h4> Welcome to MedPro - The Supply Chain DAPP</h4>
            <p style="max-width: 80%;">
            <p > <b>Manufacturer:</b> Manufacturer is a person or company that produces finished goods from raw materials by using various tools, equipment, and processes, and then sells the goods to distributors or to other manufacturers for the production of more complex goods.They manufacture the medical products upon receiving approval from FDA(Food and Drug Administration) for the raw materials,otherwise they cannot sell their products.</p></br>
   <p > <b>Distributor:</b> Distributors contribute to creating value to the health care community in terms of cost reduction via utilizing the optimum distribution route and warehouse management,and revenue enhancement through risk pooling.They distribute the medical products received from manufacturer in larger quantity to pharmacy.They also verifies the source of medical products.The medical products are distributed after packaging.</p></br>
   <p ><b>Pharmacy:</b> They receives the medical products from distributor in smaller quantity.They verifies the source of products and updates inventory.These products are purchased by end-users.These end users includes the patients, hospitals or others who purchase medical products from pharmacy.</p>
            </p>
      ...
      <div class="loginformcard" id="maincard3">
            ...
            <label type="text" class="formlabel" style="margin-top: 10px;"> Phone Number </label>
            <input type="text" class="forminput" name="phone" id="phone" onkeypress="blockSpaces(event)" required>

            <label type="text" class="formlabel" style="margin-top: 10px;"> Location </label>
            <input type="text" class="forminput" name="location" id="location" onkeypress="blockSpaces(event)" required>
